...
class Openfiles:
    ...
    'This class opens different types of files and output DataFrame massive with the size: response (bins)* PMT (N)'
    ...
    'you do not have to touch anything expect you want to add another type of file. Then create new "if"'
